  ...
  <div class="q-pa-md">
        ...
        <q-form @submit.prevent>
          <div class="">
            ...
            <div class="row q-gutter-lg">
              <q-input v-model="numeroEtiqueta" type="number" :label="pit == 'sim' ? 'PIT' : 'Nº da etiqueta'"
                :disable="pit === 'sim'" :rules="[val => etiquetaObrigatoria(val)]" @click="pitSim"
                class="q-mb-md col-md-2 col-11" required />
    ...
    <q-form>
          ...
          <q-card-section>
            <div class="q-gutter-md">
              ...
              <q-input v-model="exame.codigo" type="number" label="Código da espécie de triatomíneos" class="q-mb-md"
                :rules="[val => !!val || 'Código da espécie é obrigatório']" required />
      ...
      <q-card align="center">
        ...
        <h6 class="titleAdd">Adicionar novo
          exame</h6>
    ...
    watch: {
      codigosExames(novoCodigo) {
        ...
        novoCodigo.forEach((codigo, index) => {
          console.log(this.exames, this.responsavel, this.numeroEtiqueta, this.pit, this.dataExame)
          if (index < this.exames.length) {
            // Atualiza o nome da espécie baseado no código ou define um nome padrão
            this.exames[index].nome = codigo === '' ? '' :
              (this.especies[codigo] !== undefined ? this.especies[codigo] : 'Nome não encontrado');
          }
        })
